                                ...
                                <div className='col-md-4'> 
                                    ...
                                    <div className="col-md-12 buttons-flex-center m-top-1">
                                        ...
                                        <Link target="_blank" href="https://www.linkedin.com/in/fernandopinango">
                                            <button    className={classNames('btn btn-rounded-big btn-active m1', {'btn-inactive': skilsSize == 'open'})} >
                                        ...
                                        <Link target="_blank" href="https://github.com/fernanj2323">
                                            <button  href="https://www.linkedin.com/in/fernandopinango" taget="_blank"  className={classNames('btn btn-rounded-big  btn-active ', {'btn-inactive': skilsSize == 'open'})} >
            ...
            {skilsSize == "close"  ? (
                                    ...
                                    <div className="row col-md-12 red" >
                                       ...
                                       
                                       {
                                           ...
                                           <div className="col-md-4 p-2" key={i}>
                                               ...
                                               <div   className={classNames(' card-active-color card card-body  animate__animated animate__fadeIn', {'bg-dark': theme == 'dark'})}>
                ...
                favoriteFirst == "portfolio" ? (
                    ...
                    <div className="col-md-12 ">
                        ...
                        <div  className={classNames('card card-body  card-active-color col-md-12  padding-top0  animate__animated animate__fadeIn border-top-radius-2 border-bottom-radius-0' , {'bg-dark': theme == 'dark'})} >
                            ...
                            <div className=" row col-md-12 red " >
                                    ...
                                    projects.map(({name,description,image}, i) =>(
                                                <div className="col-md-4 p-2" key={i}>
                                                    {/* className="card h-100 " */}
                                                    <div   className={classNames(' card-second-color card card-body  animate__animated animate__fadeIn', {'bg-dark': theme == 'dark'})}>
                                                        <div className="overflow">
                                                            <img className='card-img-top' src={`/${image}`} alt=''/>
                                                        </div>
